...
# CUSTOM FUNCTIONS ----
jumbotron <- function(..., background_img = NULL, ui_box_bg_color = "rgba(0,0,0,0.5)", ui_box_text_color = "white") {
    ...
    div(
        ...
        column(
            ...
            info_card(title = "NFLX", 
                      ...
                      sub_value = "-10%", sub_icon = "arrow-down", sub_text_color = "danger")
        )
